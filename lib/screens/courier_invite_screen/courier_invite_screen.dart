import 'package:flex_mobile_app/provider/overall_price.dart';
import 'package:flex_mobile_app/screens/courier_invite_screen/widgets/columns/delivery_details_column.dart';
import 'package:flex_mobile_app/screens/courier_invite_screen/widgets/columns/receiver_column.dart';
import 'package:flex_mobile_app/screens/courier_invite_screen/widgets/columns/sender_column.dart';
...
class CourierInviteScreen extends StatefulWidget {
  ...
  @override
  State<CourierInviteScreen> createState() => _CourierInviteScreenState();
}
...
class _CourierInviteScreenState extends State<CourierInviteScreen> {
                        ...
                        if (controllerReceiverNameSurname.text.isEmpty ||
                          ...
                          setState(() {
                            ...
                            (startingValueWeight == "0kg - 0.5kg" &&
                                ...
                                : (startingValueWeight == "Guma putnička")
                                ...
                                : (startingValueWeight == "Guma putnička sa felnom")
                                ...
                                : (startingValueWeight == "Menjač manji")
                                ? context.read<OverallPrice>().add(1550)
                                : (startingValueWeight == "Menjač automatski")
              ...
              isClicked
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Vaša pošiljka iznosi ${context.watch<OverallPrice>().stringSum}",
